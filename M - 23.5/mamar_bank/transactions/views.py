...
class TransferMoneyView(LoginRequiredMixin,View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            receipt_account_no = form.cleaned_data.get('receipt_account_no')
            amount = form.cleaned_data.get('amount')
            
            recipient_account = UserBankAccount.objects.get(account_no=receipt_account_no)
            ...
            send_transaction_email(recipient_account.user, amount, "Transfer Money", "transactions/transfer_money_to_user_email.html")
            send_transaction_email(self.request.user, amount, "Transfer Money", "transactions/transfer_money_from_user_email.html")
